    ...
    <section id="root">
        <section class="welcome-part">
            <div class="info-card">
                ...
                <div class="user-details">
                    ...
                    <div class="badges">
                        <span class="blood-group-badge" style="background: #e3f2fd; color: #1565c0;"><i
                                class="bi bi-shield-lock-fill"></i> Admin Panel</span>
            ...
            <div class="additional">
                <div class="statistics">
                    ...
                    <div class="stat-box">
                        <div class="icon" style="background: #fff3e0; color: #e65100;"><i
                                class="bi bi-clipboard2-pulse-fill"></i></div>
                        <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-top: 20px;">
                    <div
                        ...
                        <h4 style="margin-bottom: 12px; font-size: 0.95rem; color: var(--text-color, #333);">Blood Type
                            Distribution</h4>
                        <canvas id="bloodTypeChart" height="220"></canvas>
                    </div>
                    <div
                        style="background: var(--card-bg, #fff); border-radius: 16px; padding: 20px; box-shadow: 0 2px 12px rgba(0,0,0,0.06);">
                        <h4 style="margin-bottom: 12px; font-size: 0.95rem; color: var(--text-color, #333);">Monthly
                            Donations</h4>
                        <canvas id="donationsChart" height="220"></canvas>
                    </div>
                    <div
                        style="background: var(--card-bg, #fff); border-radius: 16px; padding: 20px; box-shadow: 0 2px 12px rgba(0,0,0,0.06);">
                        <h4 style="margin-bottom: 12px; font-size: 0.95rem; color: var(--text-color, #333);">Requests by
                            Urgency</h4>
        ...
        <section class="user_dashboard">
            ...
            <div class="nav-links-btns"
                style="display: grid; grid-template-columns: repeat(4, 1fr); height: auto; gap: 15px; padding: 10px 0; width: 100%;">
                <style>
                    .nav-links-btns>div {
                        width: 100% !important;
                    ...
                    <div id="users-section" class="dashboard-section" style="display: none;">
                        <div class="content-wrapper">
                            <div
                                ...
                                <button class="btn btn-primary btn-sm" onclick="openModal('user')"
                                        ...
                                        <?php if (!empty($all_users)): ?>
                                            <?php foreach ($all_users as $u): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="status-badge <?php echo strtolower(str_replace(' ', '-', $u['role'])); ?>">
                                                            <?php echo $u['role']; ?>
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-1 flex-wrap">
                                                            <button class="btn btn-warning btn-sm"
                                                                onclick='openModal("user", <?php echo json_encode($u); ?>)'
                    ...
                    <div id="hospitals-section" class="dashboard-section" style="display: none;">
                        <div class="content-wrapper">
                            <div
                                ...
                                <button class="btn btn-primary btn-sm" onclick="openModal('hospital')"
                                    style="font-size: 0.85rem; padding: 6px 16px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($hosp['is_verified']): ?>
                                                            <span class="status-badge approved"><i
                                                                    class="bi bi-check-circle-fill"></i> Verified</span>
                                                        <?php else: ?>
                                                            <span class="status-badge pending"><i
                                                                    class="bi bi-exclamation-circle"></i> Pending</span>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex gap-1 flex-wrap">
                                                            <button class="btn btn-warning btn-sm"
                                                                onclick='openModal("hospital", <?php echo json_encode($hosp); ?>)'
                                                                style="font-size: 0.75rem; padding: 4px 12px;">
                                                                <i class="bi bi-pencil"></i> Edit
                                                            </button>
                                                            <?php if (!$hosp['is_verified']): ?>
                                                                <button class="btn btn-success btn-sm"
                                                                    onclick="verifyHospital(<?php echo $hosp['hospital_id']; ?>, this)"
                                                                    style="font-size: 0.75rem; padding: 4px 12px;">
                                                                    <i class="bi bi-check-lg"></i> Verify
                                                                </button>
                                                            <?php endif; ?>
                                                            <button class="btn btn-danger btn-sm"
                                                                onclick="deleteHospital(<?php echo $hosp['hospital_id']; ?>)"
                                                                style="font-size: 0.75rem; padding: 4px 12px;">
                                                                <i class="bi bi-trash"></i> Delete
                                                            </button>
                                                        </div>
                    ...
                    <div id="centers-section" class="dashboard-section" style="display: none;">
                        <div class="content-wrapper">
                            <div
                                ...
                                <button class="btn btn-primary btn-sm" onclick="openModal('center')"
                                    style="font-size: 0.85rem; padding: 6px 16px;">
                                            ...
                                            <?php foreach ($all_centers as $center): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-1 flex-wrap">
                                                            <button class="btn btn-warning btn-sm"
                                                                onclick='openModal("center", <?php echo json_encode($center); ?>)'
                                                                style="font-size: 0.75rem; padding: 4px 12px;">
                                                                <i class="bi bi-pencil"></i> Edit
                                                            </button>
                                                            <button class="btn btn-danger btn-sm"
                                                                onclick="deleteCenter(<?php echo $center['center_id']; ?>)"
                                                                style="font-size: 0.75rem; padding: 4px 12px;">
                                                                <i class="bi bi-trash"></i> Delete
                                                            </button>
                                                        </div>
                            ...
                            <div class="donations-table-wrapper">
                                <table class="donations-table">
                                    ...
                                    <tbody>
                                            ...
                                            <?php foreach ($all_requests as $req): ?>
                                                <tr>
                                                    ...
                                                    <td><strong><?php echo htmlspecialchars($req['hospital_name']); ?></strong>
                                                        <br><small
                                                            class="text-muted"><?php echo htmlspecialchars($req['city']); ?></small>
                                                    </td>
                                                    <td><span
                                                            class="blood-group-badge"><?php echo $req['blood_type_required']; ?></span>
                                                    </td>
                                                    <td><?php echo $req['units_requested']; ?></td>
                                                    <td>
                                                        <span
                                                            class="activity-status <?php echo strtolower($req['urgency_level']); ?>"
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="7" style="text-align: center; padding: 20px; color: #888;">No
                                                    blood requests found.</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                                        ...
                                        <?php if (!empty($all_donor_profiles)): ?>
                                            <?php foreach ($all_donor_profiles as $dp): ?>
                                                <tr>
                                                    ...
                                                    <td><span class="blood-group-badge"><?php echo $dp['blood_type']; ?></span>
                                                    </td>
                                                    <td><?php echo $dp['weight_kg']; ?></td>
                                                    <td><?php echo $dp['last_donation_date'] ? date('M d, Y', strtotime($dp['last_donation_date'])) : 'Never'; ?>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-1">
                                                            ...
                                                            <button class="btn btn-sm btn-outline-success" onclick="replyMessage(
                                        ...
                                        <?php if (!empty($all_appointments)): ?>
                                            <?php foreach ($all_appointments as $appt): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date('M d, Y — h:i A', strtotime($appt['scheduled_time'])); ?>
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="status-badge <?php echo strtolower(str_replace(' ', '-', $appt['status'])); ?>">
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-1 flex-wrap">
                                                            <?php if ($appt['status'] === 'Pending'): ?>
                                                                <button class="btn btn-success btn-sm"
                                                                    onclick="updateAppointment(<?php echo $appt['appointment_id']; ?>, 'approve', 'approve')"
                                                                    style="font-size: 0.75rem; padding: 4px 10px;">
                                                                    <i class="bi bi-check-lg"></i> Approve
                                                                </button>
                                                                <button class="btn btn-danger btn-sm"
                                                                    onclick="updateAppointment(<?php echo $appt['appointment_id']; ?>, 'reject', 'reject')"
                                                                    style="font-size: 0.75rem; padding: 4px 10px;">
                                                                    <i class="bi bi-x-lg"></i> Reject
                                                                </button>
                                                            <?php elseif ($appt['status'] === 'Allowed'): ?>
                                                                <button class="btn btn-primary btn-sm"
                                                                    onclick="updateAppointment(<?php echo $appt['appointment_id']; ?>, 'complete', 'mark as completed')"
                                                                    style="font-size: 0.75rem; padding: 4px 10px;">
                                                                    <i class="bi bi-check-circle"></i> Complete
                                                                </button>
                                                                <button class="btn btn-secondary btn-sm"
                                                                    onclick="updateAppointment(<?php echo $appt['appointment_id']; ?>, 'reset', 'reset to pending')"
                                                                    style="font-size: 0.75rem; padding: 4px 10px;">
