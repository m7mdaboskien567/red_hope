...
<body>
    ...
    <main class="home-wrapper">
            ...
            <div class="container">
                <div class="about-grid">
                    <div class="about-content" data-aos="fade-right">
                        ...
                        <p class="about-text">
                            RedHope is a dedicated platform designed to connect blood donors with those in critical
                            need.
                            We leverage technology to make the donation process more accessible, transparent, and
                            efficient.
                        </p>
                        <p class="about-text">
        ...
        <section class="map-section" id="centers">
            <div class="container">
                <div class="map-header" data-aos="fade-up">
                    <span class="section-badge">
                        <i class="bi bi-geo-alt-fill"></i> Find a Center
                    </span>
                    <h2 class="section-title">Blood Donation Centers</h2>
                    <p class="section-description">
                        Locate the nearest blood donation center and make your appointment today. Every donation counts.
                    </p>
                </div>
                <div class="map-container" data-aos="zoom-in">
                    <div id="bloodCentersMap"></div>
                </div>
                <div class="map-stats" data-aos="fade-up">
                    <div class="map-stat">
                        <i class="bi bi-hospital"></i>
                        <div class="stat-info">
                            <span class="stat-number" id="mapCenterCount">—</span>
                    ...
                    <div class="map-stat">
                        ...
                        <div class="stat-info">
                            <span class="stat-number" id="mapCityCount">—</span>
                            ...
                            <div class="form-grid">
                                <div class="form-field">
                                    ...
                                    <input type="text" name="name" placeholder="John Doe"
                                        value="<?php echo htmlspecialchars($user_data ? ($user_data['first_name'] . ' ' . $user_data['last_name']) : ''); ?>"
                                        required>
                                </div>
                                <div class="form-field">
    ...
    <script src="/redhope/assets/js/map.js"></script>
