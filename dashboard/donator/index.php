        ...
        <section class="welcome-part">
            <div class="info-card">
                ...
                <div class="user-details">
                    ...
                    <div class="badges">
                        <span
                            class="blood-group-badge"><?php echo htmlspecialchars($donor_profile['blood_type'] ?? 'Unknown'); ?></span>
            ...
            <div class="additional">
                <div class="statistics">
                    ...
                    <div class="stat-box">
                        ...
                        <div>
                            <h3><?php echo $last_donation_date ? date('M d, Y', strtotime($last_donation_date)) : 'N/A'; ?>
                            </h3>
                            <p>Last Donation</p>
                        </div>
                    </div>
                ...
                <div class="recent-activity">
                    ...
                    <?php if (!empty($recent_activity)): ?>
                        <?php foreach ($recent_activity as $activity): ?>
                            <div class="activity-row">
                                ...
                                <div class="act-info">
                                    ...
                                    <span><?php echo date('M d, Y', strtotime($activity['created_at'])); ?> •
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p style="color: #888; font-size: 0.9rem;">No pending requests for your blood type
                            (<?php echo htmlspecialchars($donor_blood_type ?? 'Unknown'); ?>).</p>
                    <?php endif; ?>
                </div>
            </div>
        </section>
                    ...
                    <div id="donate-section" class="dashboard-section" style="display: none;">
                        <div class="appointment-form-wrapper" style="margin: 0; box-shadow: none;">
                            ...
                            <form id="appointmentForm" class="profile-form"
                                action="/redhope/apis/create_appointment.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="notes" rows="2"
                                        placeholder="Any special requests or medical notes?"></textarea>
                                </div>
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="activity-list">
                                <?php if (!empty($all_requests)): ?>
                                            ...
                                            <div class="d-flex flex-column align-items-end gap-2">
                                                ...
                                                <?php if ($req['status'] === 'Open'): ?>
                                                    <button class="btn btn-primary btn-sm"
                                                        onclick="acceptBloodRequest(<?php echo $req['request_id']; ?>)"
                                                        style="font-size: 0.75rem; padding: 5px 15px;">
                                                        Accept Request
                                                    </button>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <p style="padding: 20px; color: #888;">No urgent requests for your blood type
                                        (<?php echo htmlspecialchars($donor_blood_type ?? 'Unknown'); ?>).</p>
                                <?php endif; ?>
                            </div>
                        </div>
                                        ...
                                        <div class="appointment-card" data-appt-id="<?php echo $appt['appointment_id']; ?>">
                                            <div class="appointment-card-body">
                                                <div class="appointment-date">
                                                    <span
                                                        class="day"><?php echo date('d', strtotime($appt['scheduled_time'])); ?></span>
                                                    <span
                                                        class="month"><?php echo date('M', strtotime($appt['scheduled_time'])); ?></span>
                                                </div>
                                                <div class="appointment-info">
                                                    <h3><?php echo htmlspecialchars($appt['center_name']); ?></h3>
                                                    <div class="appt-meta">
                                                        <span><i class="bi bi-geo-alt"></i>
                                                            <?php echo htmlspecialchars($appt['city']); ?></span>
                                                        <span><i class="bi bi-clock"></i>
                                                            <?php echo date('h:i A', strtotime($appt['scheduled_time'])); ?></span>
                                                    </div>
                                            ...
                                            <?php if ($appt['status'] === 'Pending' || $appt['status'] === 'Allowed'): ?>
                                                <div class="appointment-actions">
                                                    <button class="btn-cancel-appt"
                                                        onclick="confirmCancelAppointment(<?php echo $appt['appointment_id']; ?>)">
                                            ...
                                            <form id="rescheduleForm">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" id="reschedule_date" name="appointment_date"
                                                            class="form-control" required
                                                            min="<?php echo date('Y-m-d'); ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">New Time</label>
                                                        <input type="time" id="reschedule_time" name="appointment_time"
                                                            class="form-control" required>
                                                    </div>
                                                </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                                ...
                                <div class="filter-wrapper" style="max-width: 300px; width: 100%;">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="donationsSearch" class="form-control border-start-0"
                                            placeholder="Filter by location or status...">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <?php if (!empty($donation_history)): ?>
                                            <?php foreach ($donation_history as $donation): ?>
                                                <tr>
                                                    <td class="date-cell">
                                                        <span
                                                            class="date"><?php echo date('M d, Y', strtotime($donation['donated_at'])); ?></span>
                                                    </td>
                                                    <td class="center-cell">
                                                        <span
                                                            class="name"><?php echo htmlspecialchars($donation['location_name'] ?? 'General Donation'); ?></span>
                                                    </td>
                                                    <td><?php echo $donation['volume_ml']; ?> ml</td>
                                                    <td>
                                                        <span
                                                            class="status-badge <?php echo strtolower(str_replace(' ', '-', $donation['status'])); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content profile-form-wrapper" style="margin: 0; box-shadow: none;">
                ...
                <div class="modal-body py-4">
                    <p class="text-secondary mb-4">Please proceed to this hospital to fulfill your donation commitment.
                        Your help saves lives!</p>
                    <div class="hospital-info-card p-3 rounded"
