    ...
    <div class="dashboard-container">
        <section class="dashboard-content" style="max-width: 800px; margin: 0 auto;">
            <div class="content-header" style="text-align: center;">
                ...
                <p><?php echo $existing_hospital ? 'Your hospital registration is pending admin approval.' : 'Please fill in your hospital details to get started.'; ?></p>
            </div>
            ...
            <?php if ($existing_hospital): ?>
                ...
                <div class="pending-approval-card">
                    ...
                    <p>Your hospital registration has been submitted and is currently under review by our administrators.</p>
                    ...
                    <div class="pending-actions">
                        <a href="/redhope/apis/logout.php" class="btn-outline">
                ...
                <div class="profile-section">
                    ...
                    <form id="hospitalRegistrationForm" class="profile-form">
                        <div class="form-group">
                            ...
                            <input type="text" id="hospital_name" name="name" required placeholder="e.g., Cairo General Hospital">
                        </div>
                        <div class="form-group">
                            <label for="address">Full Address *</label>
                            <textarea id="address" name="address" required rows="3" placeholder="e.g., 123 Main Street, Downtown"></textarea>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" id="contact_number" name="contact_number" required placeholder="e.g., +20 2 1234 5678">
                            </div>
                        </div>
                        <div class="form-group">
